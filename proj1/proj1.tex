...
\author{Lenka Šoková\\\href{mailto:xsokov01@stud.fit.vutbr.cz}{xsokov01@stud.fit.vutbr.cz}}
\date{}
\maketitle
...
Hladká sazba používá jeden stupeň, druh a~řez písma. Sází se na stanovený počet cicer nebo milimetrů. Skládá se z~odstavců. Odstavec končí východovou řádkou. Věty nesmějí začínat číslicí.
...
Čím více \emph{druhů}, \textbf{řezů}, {\tiny{velikostí}}, \textcolor{red}{barev} písma a~jiných \textsc{efektů} použijeme, tím {\verb profesionálněji } bude {\fontfamily{pzc}\selectfont \Large{dokument}} vypadat.
{\huge{Č}\LARGE{t}\Large{e}\large{n}\normalsize{á}\small{ř} \footnotesize{t}\scriptsize{í}\tiny{m}} bude vždy {\Huge\bfseries nadšen!}
...
příkazem {\fontfamily{cmtt}\selectfont \textbackslash emph\{text\}} než {\fontfamily{cmtt}\selectfont \textbackslash textit\{text\}}.
...
musí být sázeny příkazy k~tomu určenými. Číslování sekcí tohoto dokumentu je zajištěno příkazem {\fontfamily{cmtt}\selectfont \textbackslash section}.
...
uvozovky typu \uv{9966} místo anglických ``uvozovek'' nebo dvojitých "uvozovek". Lze je sázet připravenými příkazy nebo při použití UTF-8 kódování i přímo.
